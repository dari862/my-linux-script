...
mv -v $temp_folder_for_download/archcraft-openbox/files/pipemenu $temp_folder_for_openbox/archcraft/openbox/
mv -v $temp_folder_for_download/pipemenu/* $temp_folder_for_openbox/archcraft/openbox/pipemenus
